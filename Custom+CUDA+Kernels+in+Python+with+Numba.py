...
get_ipython().magic('timeit np.hypot(a, b)')
...
get_ipython().magic('timeit numba_hypot(a, b)')
...
get_ipython().magic('time hypot_stride[1, 1](d_a, d_b, d_c); cuda.synchronize()')
...
get_ipython().magic('time hypot_stride[128, 64](d_a, d_b, d_c); cuda.synchronize()')
...
get_ipython().system('tar -zcvf section2.tar.gz .')
...
get_ipython().system(' cat debug/ex1.py')
...
get_ipython().system(' python debug/ex1.py')
...
get_ipython().system(' cat debug/ex1a.py')
...
get_ipython().system(' python debug/ex1a.py')
...
get_ipython().system(' cat debug/ex3.py')


# In[144]:


get_ipython().system(' cuda-memcheck python debug/ex3.py')
...
get_ipython().system(' cuda-memcheck python debug/ex3a.py')
...
get_ipython().system(' cat -n debug/ex3a.py | grep -C 2 "17"')
...
nsamples = 10000000
get_ipython().magic('timeit monte_carlo_pi(nsamples)')
...
get_ipython().magic('timeit monte_carlo_pi_device[blocks, threads_per_block](rng_states, samples_per_thread, d_out); cuda.synchronize()')
